...
public class ProcessedArticle(string title,
                            ...
                            List<TrustedLogos> articleBranding,
                            ...
                            List<Event> events) : IProcessedContentType, IContactUsMessageContainer
{
    ...
    public List<TrustedLogos> ArticleBranding = articleBranding;
