...
namespace StockportWebapp.Models
{
    public class Topic
    {
        ...
        public Topic(string name, string slug, string summary, string teaser, string metaDescription, string icon,
            ...
            string expandingLinkTitle, IEnumerable<ExpandingLinkBox> expandingLinkBoxes, string primaryItemTitle, string title, bool displayContactUs, CarouselContent campaignBanner, string tag)
        {
            Name = name;
            Title = title;
            Slug = slug;
