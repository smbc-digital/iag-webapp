...
public class BusinessIdMiddleware(RequestDelegate next, ILogger<BusinessIdMiddleware> logger)
{
    private readonly RequestDelegate _next = next;
    private readonly ILogger<BusinessIdMiddleware> _logger = logger;
