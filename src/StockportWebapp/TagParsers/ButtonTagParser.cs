...
public class ButtonTagParser : ISimpleTagParser
{
    ...
    private const string buttonClassStyle = "btn btn--width-30 button button-primary button-outline button-partialrounded btn--chevron-forward button-call-to-action";
