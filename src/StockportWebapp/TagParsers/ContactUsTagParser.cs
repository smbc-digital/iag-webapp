...
public class ContactUsTagParser : ISimpleTagParser
{
    ...
    protected Regex TagRegex => new("{{CONTACT-US:(\\s*[a-zA-Z0-9]*[^}]*)}}", RegexOptions.Compiled);

    public static Regex ContactUsMessageTagRegex => new("<!-- ##CONTACT_US_MESSAGE## -->", RegexOptions.Compiled);
