...
var domain_advanced_iframe = 'http://local.tractivity.co.uk/'; // Check if this is your wordpress root
...
window.jQuery || document.write("<script src='http://local.tractivity.co.uk/wp-includes/js/jquery/jquery.js'></script>")
