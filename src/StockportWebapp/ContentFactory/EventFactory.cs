...
public class EventFactory : IEventFactory
{
    ...
    public virtual ProcessedEvents Build(Event eventItem)
    {
        ...
        return new ProcessedEvents(eventItem.Title, eventItem.Slug, eventItem.Teaser, eventItem.ImageUrl,
                                   ...
                                   mapDetails, eventItem.BookingInformation, eventItem.Group, eventItem.Alerts, eventItem.AccessibleTransportLink, eventItem.TrustedLogos, eventItem.PhoneNumber, eventItem.Email, eventItem.Website, eventItem.MetaDescription);
    }
}
