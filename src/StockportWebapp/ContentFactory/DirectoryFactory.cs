...
public class DirectoryFactory
{
    ...
    public virtual ProcessedDirectory Build(Directory directory) => new(
                directory.Title, directory.Slug,
                directory.ContentfulId, directory.Teaser, directory.MetaDescription, 
                directory.BackgroundImage, directory.Body, directory.CallToAction, 
                directory.Alerts, directory.Entries, directory.SubDirectories,
                directory.AllEntries, directory.AllFilterThemes)
    {
