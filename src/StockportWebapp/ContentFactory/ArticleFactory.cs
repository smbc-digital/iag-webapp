...
public class ArticleFactory
{
    ...
    public virtual ProcessedArticle Build(Article article)
    {
        ...
        return new ProcessedArticle(article.Title, article.Slug, body, article.Teaser, article.MetaDescription,
            processedSections, article.Icon, article.BackgroundImage, article.Image, article.Breadcrumbs, article.Alerts, article.ParentTopic, article.AlertsInline, article.UpdatedAt, article.HideLastUpdated, article.ArticleBranding, article.LogoAreaTitle);
    }
