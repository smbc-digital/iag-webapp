...
public class TopicControllerTest
{
    ...
    public SubItem CreateASubItem(int i) => new("sub-topic" + i, "Title" + i, "Teaser", "Icon", "topic", "contentType", "image", 123, "text body", new List<SubItem>(), string.Empty, EColourScheme.Teal);
