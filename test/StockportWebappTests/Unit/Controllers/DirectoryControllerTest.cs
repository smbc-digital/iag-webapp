...
public class DirectoryControllerTest
{
    ...
    public DirectoryControllerTest()
    {
        ...
        processedDirectoryWithSubdirectories.SubItems = new List<SubItem>() {
            new("slug", "title", "teaser", "icon", "type", "contentType", "image", string.Empty, "test body", new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty)
        };
