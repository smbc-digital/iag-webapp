...
namespace StockportWebappTests_Unit.Unit.Controllers
{
    public class ContactUsAreaControllerTests
    {
        ...
        {
            // Setup 
            var contactUsArea = new ContactUsArea("title", "contact-us-area", "contact-us-area", new List<Crumb>(), new List<Alert>(), new List<SubItem>(), new List<InsetText>(), new List<ContactUsCategory>());
