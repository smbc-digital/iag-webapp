...
public class HomeControllerTest
{
    ...
    {
        new SubItem("Council Tax", "council-tax", "How to pay, discounts", string.Empty, string.Empty, string.Empty, string.Empty, 0, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal)
    };
