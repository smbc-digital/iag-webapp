...
public class HomeControllerTest
{
    ...
    {
        new SubItem("slug featuredTasks", "featured Tasks", "teaser Featured Tasks", "teaser image featured tasks", "fa fa-home", string.Empty, "image", new List<SubItem>(), EColourScheme.Teal)
    };
    
    private readonly List<SubItem> _featuredTopics = new()
    {
        new SubItem("Council Tax", "council-tax", "How to pay, discounts", string.Empty, string.Empty, string.Empty, string.Empty, new List<SubItem>(), EColourScheme.Teal)
    };
