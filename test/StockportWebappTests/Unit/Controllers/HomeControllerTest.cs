...
public class HomeControllerTest
{
    ...
    {
        new SubItem("slug featuredTasks", "featured Tasks", "teaser Featured Tasks", "fa fa-home", string.Empty, string.Empty, "image", 123, string.Empty, new List<SubItem>(), "teal")
    };
    
    private readonly List<SubItem> _featuredTopics = new()
    {
        new SubItem("Council Tax", "council-tax", "How to pay, discounts", string.Empty, string.Empty, string.Empty, string.Empty, 0, string.Empty, new List<SubItem>(), "teal")
    };
