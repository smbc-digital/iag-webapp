...
public class ContactUsMessageTagParserTest
{
    ...
    public void ShouldNotAddAnyMessageIfNoMessageGiven(string message)
    {
        ...
        var processedArticle = new ProcessedArticle("title", "slug", DefaultBody, "teaser", "meta description", new List<ProcessedSection>() { section, anotherSection }, "icon", "backgroundImage", "image", "altText", new List<Crumb>(), new List<Alert>(), DefaultTopic(), new List<Alert>(), new DateTime(), new bool(), new List<GroupBranding>(), "logoTitle");
    ...
    {
        var processedArticle = new ProcessedArticle("title", "slug", _bodyWithContactUsMessageTag, "teaser", "meta description", new List<ProcessedSection>(), "icon", "backgroundImage", "image","altText", new List<Crumb>(), new List<Alert>(), DefaultTopic(), new List<Alert>(), new DateTime(), new bool(), new List<GroupBranding>(),"logoTitle");
    ...
    public void ShouldAddErrorMessageToFirstSectionBodyWithFormTagInsideIfArticleDoesntHaveFormIfEmptySlugGiven()
    {
        ...
        var processedArticle = new ProcessedArticle("title", "slug", DefaultBody, "teaser", "meta description", new List<ProcessedSection>() { section }, "icon", "backgroundImage", "image", "altText", new List<Crumb>(), new List<Alert>(), DefaultTopic(), new List<Alert>(), new DateTime(), new bool(), new List<GroupBranding>(), "logoTitle");
    ...
    {
        var slug = "this-is-a-slug";
        var processedArticle = new ProcessedArticle("title", "slug", DefaultBody, "teaser", "meta description", new List<ProcessedSection>() { }, "icon", "backgroundImage", "image", "altText", new List<Crumb>(), new List<Alert>(), DefaultTopic(), new List<Alert>(), new DateTime(), new bool(), new List<GroupBranding>(), "logoTitle");
