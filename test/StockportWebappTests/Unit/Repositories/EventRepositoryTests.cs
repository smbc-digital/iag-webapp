...
namespace StockportWebappTests.Unit.Repositories
{
    public class EventRepositoryTests
    {
        ...
        {
            var eventSubmission = new EventSubmission("title", new DateTime(2016, 01, 01).ToString("dddd dd MMMM yyyy"), new DateTime(2017, 01, 01, 10, 00, 00), new DateTime(2017, 01, 01, 12, 00, 00), new DateTime(2016, 01, 01).ToString("dddd dd MMMM yyyy"), "frequency",
            ...
            response.Should().Contain("Start time: 10:00");
            response.Should().Contain("End time: 12:00");
