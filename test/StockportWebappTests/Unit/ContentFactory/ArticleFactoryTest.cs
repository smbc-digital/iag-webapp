...
public class ArticleFactoryTest
{
    ...
    public ArticleFactoryTest()
    {
        ...
        _article = new("title", "slug", Body, "teaser", "meta description", sections, "icon", "backgroundImage", "image", "altText", new List<Crumb>(), new List<Profile>(), new List<Document>(), new List<Alert>(), new DateTime(), false);
