...
namespace StockportWebappTests.Unit.ContentFactory
{
    public class HomepageFactoryTest
    {
        ...
        public void ItBuildsAHomepageWithProcessedBody()
        {
            ...
            var homepage = new Homepage(Enumerable.Empty<string>(), string.Empty, string.Empty, new List<SubItem>(), new List<Topic>(), new List<Alert>(), new List<CarouselContent>(), backgroundImage, freeText, null);
