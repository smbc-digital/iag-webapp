...
public class TopicFactoryTest
{
    ...
    private readonly List<SubItem> _featuredItems;
    ...
    public TopicFactoryTest()
    {
        ...
        _featuredItems = new List<SubItem>();
        _subItems = new List<SubItem>();
        _secondaryItems = new List<SubItem>();

        _topic = new Topic("name", Slug, Summary, Teaser, MetaDescription, Icon, BackgroundImage, Image, _featuredItems, _subItems, _secondaryItems, _breadcrumbs,
