...
public class ShowcaseBuilder
{
    ...
    {
        new SubItem("slug", "title", "teaser", "icon", "type", "contentType", "image.jpg", new List<SubItem>() {new SubItem("slug", "title", "teaser", "icon", "type", "contentType", "image.jpg", new List<SubItem>(), "teal") }, "teal")
    };
