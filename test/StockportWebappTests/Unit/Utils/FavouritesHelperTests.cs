...
namespace StockportWebappTests.Unit.Utils
{
    ...
    public class FavouritesHelperTests
    {
        ...
        public void ShouldPopulateFavouritePropertyToCollectionWhencallingPopulateFavourites()
        {
            ...
            groups.Add(new Group("test 1", "test1", string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, null, null, null, null, false, null, null, null, null, string.Empty, string.Empty, string.Empty, string.Empty, false, "", null, null, false));
            groups.Add(new Group("test 2", "test2", string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, null, null, null, null, false, null, null, null, null, string.Empty, string.Empty, string.Empty, string.Empty, false, "", null, null, false));
