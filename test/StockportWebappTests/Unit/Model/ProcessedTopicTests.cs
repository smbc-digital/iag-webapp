...
public class ProcessedTopicTests
{
    private readonly ProcessedTopic processedTopic = new("topic name",
                                                            ...
                                                            "image",
                                                            new List<SubItem> {
                                                                new("featured-items", "Featured Items", "Teaser", "Icon.ico", "Article", string.Empty, string.Empty, 0, string.Empty, new List<SubItem>(), "teal")
                                                            },
                                                            new List<SubItem> {
                                                                new("primary-items", "Primary Items", "Teaser", "Icon.ico", "Article", string.Empty, string.Empty, 0, string.Empty, new List<SubItem>(), "teal")
                                                            },
                                                            new List<SubItem> {
                                                                new("test-slug", "Featured Item", "Teaser", "Icon.ico", "Article", string.Empty, string.Empty, 0, string.Empty, new List<SubItem>(), "teal")
                                                            },
                                                            new List<Crumb>(),
                                                            new List<Alert> {
