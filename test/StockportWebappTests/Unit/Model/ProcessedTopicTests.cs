...
public class ProcessedTopicTests
{
    private readonly ProcessedTopic processedTopic = new("topic name",
                                                            ...
                                                            "image",
                                                            new List<SubItem> {
                                                                new("featured-items", "Featured Items", "Teaser", "Icon.ico", "Article", string.Empty, string.Empty, string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty)
                                                            },
                                                            new List<SubItem> {
                                                                new("primary-items", "Primary Items", "Teaser", "Icon.ico", "Article", string.Empty, string.Empty, string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty)
                                                            },
                                                            new List<SubItem> {
