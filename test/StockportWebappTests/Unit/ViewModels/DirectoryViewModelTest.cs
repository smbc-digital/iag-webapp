...
public class DirectoryViewModelTest
{
    ...
    public void DisplayIcons_ReturnsTrue_WhenDirectoryAndSubDirectoriesAreNotNull_AndAllSubDirectoriesHaveNonNullIcons()
    {
        ...
        Directory directory = new()
        {
            ...
            {
                new("slug", "title", "teaser", "icon", "directory", string.Empty, "image", string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty),
                new("slug2", "title2", "teaser2", "icon2", "directory2", string.Empty, "image2", string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty)
            },
        };
    ...
    public void DisplayIcons_ReturnsFalse_WhenAnySubDirectoryHasNullOrEmptyIcon()
    {
        ...
        {
            SubItems = new List<SubItem>(){
                new("slug", "title", "teaser", "icon1", "type", "contentType", "image", string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty),
                new("slug2", "title2", "teaser2", "", "type2", "contentType", "image2", string.Empty, string.Empty, new List<SubItem>(), string.Empty, string.Empty, EColourScheme.Teal, string.Empty, string.Empty)
            }
        };
