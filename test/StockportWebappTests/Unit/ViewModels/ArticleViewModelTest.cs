...
namespace StockportWebappTests.Unit.ViewModels
{
    public class ArticleViewModelTest
    {
        ...
        private void ShouldReturnTopicSubItemsListForSideBar()
        {
            ...
            var topic = new Topic(Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, subItems, secondaryItems,new List<SubItem>(), new List<Crumb>(), new List<Alert>(), false, Helper.AnyString, null, String.Empty, new List<ExpandingLinkBox>());
        ...
        private void ShouldReturnSixTopicsSubItemsForSideBar()
        {
            ...
            var topic = new Topic(Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString, Helper.AnyString,
                subItems, secondaryItems, new List<SubItem>(), new List<Crumb>(), new List<Alert>(), false, Helper.AnyString, null, "expandingLinkText", new List<ExpandingLinkBox>());
