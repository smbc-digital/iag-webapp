...
namespace StockportWebappTests.Unit.Helpers
{
    public class GroupImageURLHelperTest
    {
        ...
        public void ShouldReturnFirstCategoryImageUrlIfGroupImageUrlIsEmptyButFirstCategoryImageUrlIsNot()
        {
            ...
            Group groupWithImage = new Group("name", "slug", "phoneNumber", "email", "website", "twitter", "facebook", "address", "description", "", "thumbnail", new List<GroupCategory>() { groupCategory }, new List<Crumb>(), new MapPosition(), false, null, null, DateTime.MinValue, DateTime.MinValue, "published", string.Empty, string.Empty, string.Empty, false, string.Empty);
        ...
        {
            // Arrange
            Group groupWithImage = new Group("name", "slug", "phoneNumber", "email", "website", "twitter", "facebook", "address", "description", "", "thumbnail", new List<GroupCategory>(), new List<Crumb>(), new MapPosition(), false, null, null, DateTime.MinValue, DateTime.MinValue, "published", string.Empty, string.Empty, string.Empty, favourite: false, volunteeringText: string.Empty);
